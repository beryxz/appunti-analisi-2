...
\defn{Limite di funzioni in più variabili con epsilon-delta}{
    ...
    \[f: A \subset \Rn \rightarrow \R \]
    Sia \(\ux_0 \in \Rn \) un punto di accumulazione per \(A\). Con \(l \in \R \), si scrive:
...
Queste definizioni di limite sono equivalenti. La differenza principale sta nel dominio di \(l\).
