...
\begin{align*}
    y(x) & = 2e^{-2\ln(-x)}+ e^{-2\ln(-x)} \int_{{-1}}^{{x}} e^{2\ln(-t)} \frac{1}{t^{2}} \diff t                    \\
         & = 2e^{\ln({(-x)}^{-2})} + e^{\ln({(-x)}^{-2})} \int_{{-1}}^{{x}} e^{\ln {(-t)}^2} \frac{1}{t^{2}} \diff t \\
         & = 2e^{\ln(x^{-2})} + e^{\ln(x^{-2})} \int_{{-1}}^{{x}} e^{\ln(t^2)} \frac{1}{t^{2}} \diff t               \\
         & = 2\frac{1}{x^{2}} + \frac{1}{x^{2}} \int_{{-1}}^{{x}} \cancel{t^2} \frac{1}{\cancel{t^2}} \diff t        \\
         & = \frac{2}{x^{2}} + \frac{1}{x^{2}} \left[ t ~\Big|_{-1}^{x} \right]                                      \\
         & = \frac{2}{x^{2}} + \frac{1}{x^{2}} (x+1) = \frac{3+x}{x^2}
\end{align*}
